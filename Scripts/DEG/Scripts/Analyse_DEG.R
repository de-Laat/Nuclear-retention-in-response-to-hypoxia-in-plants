...
# last update by kk on 2017.11.02 - including Solanum lycopersicum -specific selections
...
## Metadata options
metaFile <- "Metadata_3_new.csv" #Name of metadata file in csv format.
doFilter <- F #F
...
countsFile <- "Counts.txt" #Name of metadata file

shortName <- "Gitte_Dirk" #Short name to append at the end of the filenames. If missing it will append the name of the folder where the scripts where run.
...
Groups <- as.factor(paste0(experimentFactors$Type,"_",experimentFactors$Stress,"_",experimentFactors$Hours))
...
heatmap.2(corrSamples,col=cm.colors(125), keysize = 0.5,
          cellnote = ifelse(corrSamples<0.8,"*",NA), notecol = "black",
...
cont.matrix= makeContrasts(
  ...
  "Rec_NUC_TOT"=Nuclear_1R_1-Total_1R_1,
  "Hyp2_NUC_TOT"=Nuclear_HS_2-Total_HS_2,
  "NS2_NUC_TOT"=Nuclear_NS_2-Total_NS_2,
  "Hyp9_NUC_TOT"=Nuclear_HS_9-Total_HS_9,
  "NS9_NUC_TOT"=Nuclear_NS_9-Total_NS_9,
  "Hyp_NUC_2-9"=Nuclear_HS_2-Nuclear_HS_9,
  "NS_NUC_2-9"=Nuclear_NS_2-Nuclear_NS_9,
  "Hyp_TOT_2-9"=Total_HS_2-Total_HS_9,
  "NS_TOT_2-9"=Total_NS_2-Total_NS_9,
  "TOT_HSNS_2"=Total_HS_2-Total_NS_2,
  "TOT_HSNS_9"=Total_HS_9-Total_NS_9,
  "NUC_HSNS_2"=Nuclear_HS_2-Nuclear_NS_2,
  "NUC_HSNS_9"=Nuclear_HS_9-Nuclear_NS_9,
  "TRAP_HSNS_2"=TRAP_HS_2-TRAP_NS_2,
  "Hyp_NUC_TRAP"=Nuclear_HS_2-TRAP_HS_2,
  "Hyp_TOT_TRAP"=Total_HS_2-TRAP_HS_2,
  "NS_NUC_TRAP"=Nuclear_NS_2-TRAP_NS_2,
  "NS_TOT_TRAP"=Total_NS_2-TRAP_NS_2,
...
write.table(DE_All,"DEG_AllContrasts_Gitte_Dirk.xls",sep = "\t",row.names = TRUE,quote = FALSE)
